...
import os  # Necesario para extraer el nombre del archivo profesionalmente
...
def auditoria_estricta(texto):
    ...
    # 1. LISTA DE SALVACIÓN: Si dice esto, es POSITIVO
...
if archivo_client:
    # Extracción del nombre de la empresa desde el archivo (Activo del Sistema)
    ...
    # --- CAMBIO SOLICITADO: DATOS CLIENTE DINÁMICO ---
